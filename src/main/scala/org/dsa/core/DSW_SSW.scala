...
/**
  ...
  */
class DSW_SSW extends SequenceAlignmentTime {
  /**
...
object DSW_SSW {
  def main(args: Array[String]) {
    ...
    val dsw_ssw = new DSW_SSW()
    dsw_ssw.runWithIime(subMatrix: String,queryFile: String, dbFile: String,  splitNum: Int, taskNum: Int, topK: Int)
  }
