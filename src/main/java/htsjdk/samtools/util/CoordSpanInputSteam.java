...
/**
 * An input stream that wraps a {@link SeekableStream} to produce only bytes specified within coordinates.
...
public class CoordSpanInputSteam extends InputStream {
    ...
    /**
     * Wrap {@link SeekableStream} to read only bytes within boundaries specified in the coords array.
